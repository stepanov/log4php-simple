...
#        $this->layout->getHeader() . $this->body . $this->layout->getFooter(),
        ...
        if ($from !== null and $to !== null and $this->layout !== null) {

            $subject    = $this->getSubject();            

            LoggerLog::debug("LoggerAppenderMail::append() sending mail from=[{$from}] to=[{$to}] subject=[{$subject}]");
            
            mail(
                $to, $subject, $this->layout->format($event), "From: {$from}\r\n"
            );
        }
